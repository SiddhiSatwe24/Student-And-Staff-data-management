...
public class DisplayStudent {
	...
	private JFrame frmDisplayStudentInformation;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmDisplayStudentInformation.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmDisplayStudentInformation = new JFrame();
		frmDisplayStudentInformation.getContentPane().setBackground(new Color(234, 234, 234));
		frmDisplayStudentInformation.setTitle("Display Student Information");
		Toolkit kit = Toolkit.getDefaultToolkit();
		Dimension screenSize = kit.getScreenSize();
		int width = screenSize.width;
		int height = screenSize.height;
		frmDisplayStudentInformation.setSize(width, height);
		frmDisplayStudentInformation.setLocationRelativeTo(null);
		frmDisplayStudentInformation.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmDisplayStudentInformation.getContentPane().setLayout(null);
		...
		frmDisplayStudentInformation.getContentPane().add(lblNewLabel);

		JButton btnBack = new JButton("Back");
		btnBack.setBounds(115, 695, 138, 45);
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frmDisplayStudentInformation.setVisible(false);
			}
		});
		btnBack.setFont(new Font("Arial Black", Font.BOLD, 20));
		frmDisplayStudentInformation.getContentPane().add(btnBack);
		...
		frmDisplayStudentInformation.getContentPane().add(btnShow);
		...
		frmDisplayStudentInformation.getContentPane().add(btnClose);
		...
		frmDisplayStudentInformation.getContentPane().add(scrollPane);
	}
}
