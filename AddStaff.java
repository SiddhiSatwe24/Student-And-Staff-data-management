...
public class AddStaff {
	...
	private JFrame frmAddStaffInformation;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmAddStaffInformation.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmAddStaffInformation = new JFrame();
		frmAddStaffInformation.setTitle("Add Staff Information");
		Toolkit kit = Toolkit.getDefaultToolkit();
		Dimension screenSize = kit.getScreenSize();
		int width = screenSize.width;
		int height = screenSize.height;
		frmAddStaffInformation.setSize(width , height);
		frmAddStaffInformation.setLocationRelativeTo(null);
		frmAddStaffInformation.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmAddStaffInformation.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Staff Login Details");
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("First Name");
		lblNewLabel_1.setFont(new Font("Arial Black", Font.BOLD, 20));
		lblNewLabel_1.setBounds(193, 96, 138, 45);
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("Last Name");
		lblNewLabel_1_1.setFont(new Font("Arial Black", Font.BOLD, 20));
		lblNewLabel_1_1.setBounds(193, 187, 138, 45);
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_1);
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_1_3 = new JLabel("Address");
		lblNewLabel_1_3.setFont(new Font("Arial Black", Font.BOLD, 20));
		lblNewLabel_1_3.setBounds(193, 371, 138, 45);
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_3);
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_4);
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_5);
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_6);
		...
		frmAddStaffInformation.getContentPane().add(lblNewLabel_1_7);
		
		JButton btnNewButton = new JButton("Back");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frmAddStaffInformation.setVisible(false);
			}
		});
		btnNewButton.setFont(new Font("Arial Black", Font.BOLD, 20));
		btnNewButton.setBounds(159, 687, 138, 45);
		frmAddStaffInformation.getContentPane().add(btnNewButton);
		JComboBox comboDegree = new JComboBox();
		comboDegree.setFont(new Font("Arial Black", Font.BOLD, 15));
		comboDegree.setModel(new DefaultComboBoxModel(new String[] {"BE", "BTECH", "BCA", "MCA", "ME", "MBA", "PHD"}));
		comboDegree.setBounds(1037, 457, 277, 75);
		frmAddStaffInformation.getContentPane().add(comboDegree);
		...
		frmAddStaffInformation.getContentPane().add(chckbxJAVA);
		...
		frmAddStaffInformation.getContentPane().add(chckbxCpp);
		
		JDateChooser dateChooser = new JDateChooser();
		dateChooser.setDateFormatString("dd-MM-yyyy");
		dateChooser.setBounds(385, 558, 334, 33);
		frmAddStaffInformation.getContentPane().add(dateChooser);
		
		txtFirstName = new JTextField();
		txtFirstName.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		txtFirstName.setBounds(385, 94, 936, 45);
		frmAddStaffInformation.getContentPane().add(txtFirstName);
		...
		frmAddStaffInformation.getContentPane().add(btnReset);
		...
		frmAddStaffInformation.getContentPane().add(btnSave);
		...
		frmAddStaffInformation.getContentPane().add(btnExit);
